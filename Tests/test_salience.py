...
class TestSalienceMode(unittest.TestCase):
    ...
    def test_router_decides_executive_control_mode(self, mock_create):
    ...
    def test_router_parsing_fallback(self, mock_create):
        """Test router fallback logic when LLM call fails."""
        mock_create.side_effect = Exception("Connection timed out")

        res = salience_router_node(self.state)
        self.assertEqual(res.target_subgraph, "ExecutiveControlMode")
        self.assertTrue("Mock fallback" in res.explanation)
    ...
    def test_run_executive_subgraph(self, mock_build, mock_init):
        ...
        mock_res.final_answer = "ECN Reasoning Output"
        mock_res.model_dump.return_value = {"reasoning": "ECN Reasoning Output", "final_answer": "ECN Reasoning Output"}
        ...
        self.assertEqual(res.ecn_state, {"reasoning": "ECN Reasoning Output", "final_answer": "ECN Reasoning Output"})
