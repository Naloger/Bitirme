...
def download_spacy_models():
    ...
    try:
        ...
        from services.Libs.Lemmatizer.Models.model_cache import is_spacy_model_available
...
def download_stanza_models():
    ...
    try:
        import stanza
        from services.Libs.Lemmatizer.Models.model_cache import is_stanza_language_available
